...
radioStationsInIndia:
  sectionHeading: "Explore Indian Radio Stations Online by Category"
  sectionSubtext: "Some of the popular radio stations online by category are:"
  popularStationsHeading: "Some popular radio stations across India are:"
  title:
    text: "1. FM Radio Stations in India"
    size: "2xl"
    weight: "500"
  paragraphs:
    - "India has numerous popular FM radio stations, including commercial networks like Radio Mirchi, Red FM, Radio City, Big FM, and Fever FM, alongside public broadcaster All India Radio (AIR) channels such as Vividh Bharati, FM Gold, and FM Rainbow..."

simpleSteps:
  heading: "Simple steps to listen to Indian radio online"
  description: "To experience vast Indian radio content online, just follow these easy steps and pick your mood -"
  items:
...
benefits:
  ...
  description: "Listening to the radio online has many benefits compared to listening to traditional radio:"
  items:
...
stations:
  - name: "Radio Mirchi"
    ...
    languages: "Hindi, Telugu, Punjabi, Malayalam, Tamil, Kannada, Bengali, Gujarati, Multilingual, International, Marathi"
    country: "India"
  - name: "Red FM"
    frequency: "93.5 FM"
  ...
  - name: "Fever FM"
    ...
    genre: "Bollywood"
    languages: "Hindi, English, Marathi in Mumbai, Tamil in Chennai, Kannada in Bengaluru"
    country: "India"
...
languageSection:
  sectionHeading: "Indian Radio Stations by Language"
  sectionSubtext: "India is better known for its diversity of languages. Therefore, online radio makes it easy to cater to people's needs."
  listHeading: "Here is a list of language-based stations:"
  badgeLabel: "Radio Stations"
...
languages:
  ...
  - language: "Punjabi Radio Stations"
    stations:
      - "All India Radio Punjabi Channels"
      - "Punjabi Fever 107.2 FM"
  ...
  - language: "Urdu Radio Stations"
    stations:
      - "Radio Charminar 107.8 FM"
      - "AIR Urdu Service"

citySectionHeading: "Indian Radio Stations by City & Region"
citySectionSubtext: "You can also find regional voices and city vibes through Indian radio online.
