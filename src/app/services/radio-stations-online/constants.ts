...
export const heroData = {
  ...
  subheading:
    "Discover Thousands of Live Radio Stations from anywhere around the globe",
  tagline: "Free. Ad-Free. Anytime. Anywhere.",
  description:
    "Tales FM is your free, ad-free, and global hub for live online radio. Discover and instantly tune into thousands of stations covering music, news, talk shows, and cultural broadcasts, all accessible on your device with a single tap.",
  ctaButtons: [
    { label: "Download Now" },
    { label: "Listen Live" },
  ],
...
export const header: SectionContent = {
    title: {
...
export   const providedValues: SectionContent[] = [
    {
      title: {
  ...
  export const radioHeroData = {
  heading: "Online Radio Stations Made Simple",
  subheading: "Start Listening to Free Radio Today",
  description:
    "Tales FM revolutionizes the radio listening experience. This complimentary, web-based platform delivers global, live access to radio broadcasts, effectively removing the geographical and technical barriers associated with traditional radio.",
  button: {
    label: "Get Your App",
